...
from mamkit.components.data import PairVocabBuilder, PairMultimodalProcessor, PairAudioTransformer
...
if __name__ == '__main__':
    ...
    save_path = Path(__file__).parent.parent.resolve().joinpath('results', 'marg', 'arc', 'text_audio_lstm_wavlm')
