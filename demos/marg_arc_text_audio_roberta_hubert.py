...
from mamkit.data.collators import PairMultimodalCollator, PairTextTransformerCollator, PairAudioOutputCollator
...
if __name__ == '__main__':
    ...
    save_path = Path(__file__).parent.parent.resolve().joinpath('results', 'marg', 'arc', 'text_audio_roberta_hubert')
    ...
    for seed in config.seeds:
        ...
        for split_info in loader.get_splits(key='mancini-et-al-2022'):
            processor = PairMultimodalProcessor(audio_processor=PairAudioTransformerExtractor(
