...
from mamkit.components.data import MultimodalProcessor, AudioTransformer
...
if __name__ == '__main__':
    ...
    save_path = Path(__file__).parent.parent.resolve().joinpath('results', 'ukdebates', 'text_audio_bert_wavlm')
