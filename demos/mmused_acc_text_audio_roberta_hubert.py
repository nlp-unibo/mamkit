...
if __name__ == '__main__':
    ...
    save_path = Path(__file__).parent.parent.resolve().joinpath('results', 'mmused', 'acc', 'text_audio_roberta_hubert')
    ...
    config = MMTransformerConfig.from_config(key=ConfigKey(dataset='mmused',
                                                           input_mode=InputMode.TEXT_AUDIO,
                                                           task_name='acc',
