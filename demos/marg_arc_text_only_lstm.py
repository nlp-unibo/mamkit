...
from mamkit.components.collators import PairUnimodalCollator, PairTextCollator
from mamkit.components.data import MArg, InputMode
from mamkit.components.data import PairVocabBuilder, PairUnimodalProcessor
