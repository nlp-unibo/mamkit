...
from mamkit.components.collators import PairMultimodalCollator, PairTextTransformerOutputCollator, PairAudioCollator
from mamkit.components.data import MArg, InputMode
from mamkit.components.data import PairMultimodalProcessor, PairAudioTransformerExtractor, PairTextTransformer
from mamkit.models.text_audio import PairEnsemble
...
if __name__ == '__main__':
    ...
    save_path = Path(__file__).parent.parent.resolve().joinpath('results', 'marg', 'arc', 'text_audio_ensemble_hubert')
    ...
    config = EnsembleConfig.from_config(key=ConfigKey(dataset='marg',
                                                      input_mode=InputMode.TEXT_AUDIO,
                                                      task_name='arc',
