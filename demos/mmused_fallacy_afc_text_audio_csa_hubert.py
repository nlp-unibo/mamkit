...
from mamkit.components.collators import MultimodalCollator, TextTransformerOutputCollator, AudioCollator
from mamkit.components.data import MMUSEDFallacy, InputMode
from mamkit.components.data import MultimodalProcessor, AudioTransformerExtractor, TextTransformer
...
if __name__ == '__main__':
    ...
    save_path = Path(__file__).parent.parent.resolve().joinpath('results', 'mmused-fallacy', 'afc', 'text_audio_csa_hubert')
    ...
    config = CSAConfig.from_config(key=ConfigKey(dataset='mmused-fallacy',
                                                 input_mode=InputMode.TEXT_AUDIO,
                                                 task_name='afc',
