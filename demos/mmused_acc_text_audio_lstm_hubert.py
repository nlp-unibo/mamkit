...
from mamkit.components.collators import MultimodalCollator, TextCollator, AudioCollator
from mamkit.components.data import MMUSED, InputMode
from mamkit.components.data import VocabBuilder, MultimodalProcessor, AudioTransformerExtractor
...
if __name__ == '__main__':
    ...
    save_path = Path(__file__).parent.parent.resolve().joinpath('results', 'mmused', 'acc', 'text_audio_lstm_hubert')
