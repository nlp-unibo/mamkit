...
if __name__ == '__main__':
    ...
    save_path = Path(__file__).parent.parent.resolve().joinpath('results', 'mmused', 'acc', 'audio_only_transformer_hubert')
    ...
    config = TransformerEncoderConfig.from_config(key=ConfigKey(dataset='mmused',
                                                                input_mode=InputMode.AUDIO_ONLY,
                                                                task_name='acc',
