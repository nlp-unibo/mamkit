...
from mamkit.components.collators import UnimodalCollator, AudioCollator
from mamkit.components.data import MMUSEDFallacy, InputMode
from mamkit.components.data import UnimodalProcessor, AudioTransformer
...
if __name__ == '__main__':
    ...
    save_path = Path(__file__).parent.parent.resolve().joinpath('results', 'mmused', 'afc', 'audio_only_lstm_wavlm')
