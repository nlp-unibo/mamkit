...
from mamkit.components.data import VocabBuilder, MultimodalProcessor, MFCCExtractor
...
if __name__ == '__main__':
    ...
    save_path = Path(__file__).parent.parent.resolve().joinpath('results', 'mmused', 'acc', 'text_audio_lstm_mfcc')
