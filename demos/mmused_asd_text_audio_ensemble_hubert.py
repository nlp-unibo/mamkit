...
if __name__ == '__main__':
    ...
    save_path = Path(__file__).parent.parent.resolve().joinpath('results', 'mmused', 'asd', 'text_audio_ensemble_hubert')
    ...
    config = EnsembleConfig.from_config(key=ConfigKey(dataset='mmused',
                                                      input_mode=InputMode.TEXT_AUDIO,
                                                      task_name='asd',
