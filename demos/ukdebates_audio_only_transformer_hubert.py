...
from mamkit.components.data import AudioTransformerExtractor, UnimodalProcessor
...
if __name__ == '__main__':
    ...
    save_path = Path(__file__).parent.parent.resolve().joinpath('results', 'ukdebates', 'audio_only_transformer_hubert')
    ...
    config = TransformerEncoderConfig.from_config(key=ConfigKey(dataset='ukdebates',
                                                                input_mode=InputMode.AUDIO_ONLY,
                                                                task_name='asd',
