...
if __name__ == '__main__':
    ...
    save_path = Path(__file__).parent.parent.resolve().joinpath('results', 'marg', 'arc', 'text_audio_multa_hubert')
    ...
    config = MulTAConfig.from_config(key=ConfigKey(dataset='marg',
                                                   input_mode=InputMode.TEXT_AUDIO,
                                                   task_name='arc',
