...
if __name__ == '__main__':
    ...
    save_path = Path(__file__).parent.parent.resolve().joinpath('results', 'mmused', 'acc', 'text_only_roberta')
    ...
    config = TransformerConfig.from_config(key=ConfigKey(dataset='mmused',
                                                         task_name='acc',
                                                         input_mode=InputMode.TEXT_ONLY,
