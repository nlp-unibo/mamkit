...
from mamkit.components.data import PairUnimodalProcessor, PairAudioTransformerExtractor
...
if __name__ == '__main__':
    ...
    save_path = Path(__file__).parent.parent.resolve().joinpath('results', 'marg', 'arc', 'audio_only_transformer_hubert')
    ...
    for seed in config.seeds:
        ...
        for split_info in loader.get_splits(key='mancini-et-al-2022'):
            processor = PairUnimodalProcessor(features_processor=PairAudioTransformerExtractor(
